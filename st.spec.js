...
describe('Шторм Онлайн', function() {
  this.timeout(10000)
  this.slow(1000)
  let driver
...
describe('Сервер '+i, function(done) {
    ...
    this.slow(4000)
    let serverid = i
    let link = site+"games/"+gamecode+"/server/"+serverid
    let serverselector = "//a[contains(@href, '/games/"+gamecode+"/server/"+serverid+"')]"
