...
describe('Eternal Fury RU', function() {
  ...
  afterEach(async function() {
    ...
    if(process.env.GIT_BRANCH) {
      execName = 'Jenkins (from Git commit)'+'<br>'+'branch: '+process.env.GIT_BRANCH+'<br>'+'commit: '+process.env.GIT_COMMIT+'<br>'+'Author: '+process.env.GIT_COMMITTER_NAME+'('+process.env.GIT_COMMITTER_EMAIL+')'
    }
